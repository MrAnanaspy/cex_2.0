...
class Application(models.Model):
    ...
    task = models.TextField(max_length=30, verbose_name='Задача к разработке', null=True, blank=True)
    quantity = models.IntegerField(max_length=30, verbose_name='Кол-во', default=0)
    ...
    weight_work_piece = models.FloatField(max_length=30, verbose_name='Вес заготовки, Кг', default=0)
    urgency = models.IntegerField(max_length=30, choices=URGENCY, verbose_name='Срочность', default=3)
